...
def main(image_dir, txt_dir, save_dir):
    ...
    for i in list_all_txt:
        ...
        srcImage = os.path.join(image_dir, name[:-8] + '.jpg')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r'J:\data\animan\train_img', help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r'J:\data\animan\txt', help='txt path dir')
    parser.add_argument('--save-dir', default=r'J:\data\animan\split', type=str, help='save dir')
